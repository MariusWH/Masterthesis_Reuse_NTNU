...
namespace MasterthesisGHA.Components
{
    public class ParametricTruss : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddPointParameter("StartPoints", "StartPoints", "", GH_ParamAccess.item, new Point3d(0, 0, 0));
            pManager.AddPointParameter("EndPoints", "EndPoints", "", GH_ParamAccess.item, new Point3d(1, 0, 0));
            pManager.AddIntegerParameter("LengthDivisions", "LengthDivisions", "", GH_ParamAccess.item);
            pManager.AddNumberParameter("Heigths", "Heights", "", GH_ParamAccess.item, 1000);
            pManager.AddNumberParameter("Widths", "Widths", "", GH_ParamAccess.item, 1000);
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                return Properties.Resources.ParametricTruss;
            }
        }
